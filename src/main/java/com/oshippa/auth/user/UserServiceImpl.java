...
import com.oshippa.auth.user.exception.AuthenticationException;
import com.oshippa.auth.user.exception.DuplicateUserException;
import com.oshippa.auth.user.exception.UserNotFoundException;
...
public class UserServiceImpl extends BaseService implements UserService, UserDetailsService {
    ...
    public ApiUser createUser(final CreateUserRequest createUserRequest) {
        ...
        Assert.notNull(createUserRequest);
