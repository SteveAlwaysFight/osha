...
import com.oshippa.auth.user.Role;
import com.oshippa.auth.user.User;
import com.oshippa.auth.user.UserService;
...
import com.oshippa.auth.user.api.CreateUserResponse;
...
public class UserResource extends BaseResource {
    ...
    public Response signupUser(final CreateUserRequest request, @Context SecurityContext sc, @Context UriInfo uriInfo) {
        ...
        logger.info("creating user " + user.getName() + " " + user.getEmailAddress() + " " + user.getId());
