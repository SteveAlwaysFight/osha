...
import com.oshippa.auth.mail.MailSenderService;
import com.oshippa.auth.user.*;
import com.oshippa.auth.user.resource.MeResource;
import com.oshippa.auth.user.resource.PasswordResource;
import com.oshippa.auth.user.resource.UserResource;
import com.oshippa.auth.user.resource.VerificationResource;
